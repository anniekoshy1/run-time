...
const GearPage = () => {
  ...
  const handleClick = (category) => {
    ...
    setSelectedItems(data); // Set data for the modal
      ...
      <section className="gear-section">
        ...
        <div className="gear-container">
          ...
          <div className="gear-item" onClick={() => handleClick("Lacrosse Balls")}>
            <img src={ballImage} alt="Lacrosse Balls" />
          ...
          {userItems.map((item, index) => (
            <div className="gear-item" key={index}>
              <img src={item.image || "path/to/default-image.jpg"} alt={item.name} /> {/* Placeholder image if none */}
